import { AudioScenarioType, VideoMirrorModeType } from '../AgoraBase';
import { MediaSourceType, VideoSourceType } from '../AgoraMediaBase';
...
export class IRtcEngineImpl {
  ...
  setFaceShapeAreaOptions(options) {
    let type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : MediaSourceType.PrimaryCameraSource;
  ...
  getFaceShapeBeautyOptions() {
    let type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : MediaSourceType.PrimaryCameraSource;
